...
export function Nav() {
  // `solid` flips on once the gradient hero has scrolled past the bar, so the
  // nav rides transparent over the hero (cream text) then turns into a light
  // blurred bar (plum text) over the rest of the page.
  ...
  // The open mobile sheet always wants the readable (light) treatment.
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      >
        ...
        >
          <a href="#top" className="flex items-center" aria-label="Vantage Connections home">
